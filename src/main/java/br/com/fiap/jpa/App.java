...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("============ Listar dados básicos dos alunos ==============");
		...
		System.out.println("============ Listar página 1 de alunos ==============");
		
		alunoService.listarPaginado(1).forEach(System.out::println);
		
		System.out.println("============ Listar página 2 de alunos ==============");
		...
		System.out.println("============ Listar Disciplinas por carga horária ==========");
